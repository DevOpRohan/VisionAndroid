...
class adapter( private val listener: chatActivity): RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
...
class MychatViewHolder(itemViews: View): RecyclerView.ViewHolder(itemViews){
    ...
    var loading: ProgressBar= itemViews.findViewById(R.id.linearProgressIndicator)
